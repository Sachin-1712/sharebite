...
const donationIds = {
  ...
  ashaCurdRice: '1111aaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
  ashaUpmaBoxes: '2222bbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb',
...
const seedDonations = [
  ...
  {
    id: donationIds.ashaCurdRice,
    donor_id: ids.donors.koramangala,
    title: '42 Curd Rice Meal Cups',
    category: 'cooked_meals',
    food_type: 'Curd rice cups',
    quantity: 42,
    unit: 'cups',
    urgency: 'medium',
    prepared_at: hoursAgo(9),
    expires_at: hoursAgo(2),
    pickup_start: hoursAgo(8),
    pickup_end: hoursAgo(7),
    location_name: 'Koramangala Kitchen, 4th Block, Koramangala, Bangalore',
    latitude: 12.9352,
    longitude: 77.6245,
    notes: 'Delivered lunch cups packed after a corporate catering order.',
    is_vegetarian: true,
    status: 'delivered',
    accepted_by_ngo_id: ids.ngos.reliefTrust,
  ...
  {
    id: donationIds.ashaUpmaBoxes,
    donor_id: ids.donors.koramangala,
    title: '20 Millet Upma Breakfast Boxes',
    category: 'cooked_meals',
    food_type: 'Millet upma',
    quantity: 20,
    unit: 'boxes',
    urgency: 'medium',
    prepared_at: hoursAgo(18),
    expires_at: hoursAgo(12),
    pickup_start: hoursAgo(17.5),
    pickup_end: hoursAgo(16.5),
    location_name: 'Koramangala Kitchen, 4th Block, Koramangala, Bangalore',
    latitude: 12.9352,
    longitude: 77.6245,
    notes: 'Delivered breakfast boxes from an early community catering batch.',
    is_vegetarian: true,
    status: 'delivered',
    accepted_by_ngo_id: ids.ngos.annadaan,
